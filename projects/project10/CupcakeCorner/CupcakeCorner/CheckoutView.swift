...
//  CupcakeCorner
//
//  Created by Rodrigo Llaguno on 07/08/24.
//
...
struct CheckoutView: View {
    ...
    var body: some View {
        ...
        .alert("Order could not be placed successfully.", isPresented: $showingOrderFailure) {
            Button("OK") {
                
            }
        } message: {
            Text("Check internet connection or try again later.")
        }
    }
